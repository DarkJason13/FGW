...
return   ['$scope', 'appUtilities', function ($scope, appUtilities){
   var key        = 'fgwLanStatistics', myscope = null; // defines the name of the object where this table should put all its variable (to avoid $scope pollution)
 ...
 ******************************************************************************/
   ...
   (function _initialize (){
      ...
      myscope = {
         criticalError:          null,
         loadInProgress:         true,   // controls loading panel visibility
 ...
 ******************************************************************************/
   ...
   $scope[key].actionGetData = function actionGetData (){
      ...
      .finally(function(){
         ...
         $console.warn("actionGetData::myscope", myscope);
      });
