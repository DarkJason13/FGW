...
define(['angularAMD', 'uxfwk', 'uxfwk.table'
        ...
        ], function controller (angularAMD, uxfwk){
   var $console = uxfwk.$console, $U = uxfwk.$U;
   function debug(){ var args = uxfwk.toArray(arguments); args.unshift('FGW::WAN::STATISTICS'); $console.debug.apply($console, args); }
   function info(){ var args = uxfwk.toArray(arguments); args.unshift('FGW::WAN::STATISTICS'); $console.info.apply($console, args); }
...
return   ['$scope', 'appUtilities', function ($scope, appUtilities){
   var key        = 'fgwWanStatistics', myscope = null; // defines the name of the object where this table should put all its variable (to avoid $scope pollution)
 ...
 ******************************************************************************/
   ...
   $scope[key].actionGetData = function actionGetData (){
      ...
      .finally(function(){
         ...
         $console.warn("myscope", $scope[key]);
      });
