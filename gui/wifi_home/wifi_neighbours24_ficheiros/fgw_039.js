...
define(['angularAMD', 'uxfwk', 'uxfwk.table'
        ...
        , 'uxfwk.require.css!modules/fgw.wifi/fgw.wifi.devices'
        , 'uxfwk.fgw.wifi.rules'
], function _module (angularAMD, uxfwk){'use strict';
   var $console = uxfwk.$console, $U = uxfwk.$U;
   function debug(){ var args = uxfwk.toArray(arguments); args.unshift('FGW::WIFI::DEVICES'); $console.debug.apply($console, args); }
   function info(){ var args = uxfwk.toArray(arguments); args.unshift('FGW::WIFI::DEVICES'); $console.info.apply($console, args); }
...
return  ['$scope', 'appUtilities'
   ...
   var dao = {portmirror:{}}, readers = {}, common = {}, rules = { wifi: {} }, zpriv = {}, myscope = null;
   var key = 'fgwWifiDevices';
   var solution = 'fgw';
...
myscope.actionSortData = function (columnId, bAsc){
   ...
   switch ( columnId ){
      ...
      case 'netName':         attr = attr || 'netName';
...
zpriv.validators = function (){ var locals = {};
   ...
   uxfwk.map2api(rules.wifi.field, myscope.validators, locals, ['hostName', 'ssid', 'portName', 'mac', 'ip', 'leaseTime', 'ipv6', 'linkLocalIpv6']);
};// @validators
